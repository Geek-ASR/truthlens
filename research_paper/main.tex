...
honestly as unresolved rather than claimed fixed. Every number in this paper is reported with its exact sample size
...
\item \textbf{Scale the held-out benchmark past $n=9$} -- \emph{partially
  addressed}: grew to 15 (Section~\ref{sec:foundationphase}), still
  short of the 20--30 target and the $\sim$40--60 needed for real
  McNemar power; the $\sim$8\% Tier-1 sourcing hit rate remains the
  binding constraint on how fast this can scale further.
